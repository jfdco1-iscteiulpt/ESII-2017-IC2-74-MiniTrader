...
public class MicroServer implements MicroTraderServer {
	...
	/**
	 * Check if the quantity of the client's order is above or equal to 10 or
	 * else sends a error to the order's sender
	 * 
	 * @param order
	 *            is the order that the sender has just sent to the server
	 * @return true if quantity is above or equal than 10 false if quantity is
	 *         less than 10
	 */
	...
	/**
	 * Record all the transactions in an XML document with sellers/buyers
	 * identification
	 * 
	 * @param o
	 *            is the order that the sender has just sent to the server
